        ...
        if($numSegnalazioniP > 0 || $numSegnalazioniC > 0 ){
            ...
            foreach($segnalazioni_commenti as $segnalazione_commento){
                ...
                if($commento != null){
                  ...
                  echo "              <td class=\"tools\">\n";
                  echo "                <form class=\"search\" action=\"view.php\" method=\"get\">\n";
                  echo "                  <div class=\"nascondi\"><input type=\"hidden\" name=\"id_progetto\" value=\"".$id_progetto."\"></div>\n";
                  echo "                  <button type=\"submit\">&#128269;</button>\n";
                  echo "                </form>\n";
                  ...
                  echo "                  <button type=\"submit\">Rimuovi Contenuto</button>\n";
                  echo "                </form>\n";
                  echo "                <form class=\"r-report\" action=\"../../lib/rimuovere_report_commento.php\" method=\"post\"></input></div>\n";
                  echo "                  <div class=\"nascondi\"><input type=\"hidden\" name=\"id_commento\" value=\"" . $id_commento . "\"></input></div>\n";
